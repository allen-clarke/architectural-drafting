    ...
    <footer className="bg-black py-2.5 px-3.5">
      <div className="flex flex-col">
        <div className="flex justify-start items-center">
          <p className="text-white text-2xl uppercase anton-sc">
            Clarke Drafting
          </p>
        </div>
        <div>
          <p className="font-extralight font-sans text-white pt-4">
      ...
      <div className="flex flex-col justify-between content-center items-center mt-2 pb-6">
        <div>
          <p className="flex items-center text-white font-bold font-sans">
            <i className="bx bx-current-location bx-sm mr-0.5"></i>Buchanan |
            Grand Bassa | Liberia
          </p>
        </div>
        <div>
          <p className="flex items-center text-white font-extrabold font-sans">
